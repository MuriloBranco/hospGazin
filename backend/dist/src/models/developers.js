...
__decorate([
    (0, typeorm_1.ManyToOne)(() => levels_1.Levels, level => level.developers),
    (0, typeorm_1.JoinColumn)({ name: 'level' }),
    __metadata("design:type", levels_1.Levels)
], Developers.prototype, "level", void 0);
